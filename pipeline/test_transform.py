...
class TestCleaningFunctions:
    ...
    def test_get_required_columns_raises_error_when_column_is_not_in_df(empty_df):
    ...
    def test_check_valid_sale_raises_error_when_invalid_df_given(bad_df):
    ...
    def test_clean_urls_raises_error_when_url_is_invalid(bad_df):
    ...
    def test_clean_dataframe_raises_error_when_df_is_empty(empty_df):
